    ...
    partial class ImagenDao
    {
        ...
        public void create(SqlConnection conn, Imagen valueObject)
        {
            ...
            try
            {
                ...
                if (valueObject.IMAGEN != null && valueObject.IMAGEN.Length > 0)
        ...
        public List<Imagen> searchMatching(SqlConnection conn, Imagen valueObject)
        {
            ...
            //if (valueObject.IMAGEN.Length > 0)
            //{
            //    if (first) { first = false; }
            //    sql += "AND IMAGEN= '" + getByteToString(valueObject.IMAGEN) + "' ";
            //}
        ...
        public String getByteToString(byte[] tmpByte)
        {
            String result = "";
            for (int i = 0; i < tmpByte.Length; i++)
            {
                result += tmpByte[i].ToString();
            }
            return result;
        }
    }
