...
partial class EmpresaDao {
	...
	public void create(SqlConnection conn, Empresa valueObject) {
		...
		try {
			...
			" ID_MUNICIPIO, ID_IMAGEN, ID_REDES_SOCIALES,"+
			" NIT, RAZON_SOCIAL, DIRECCION_CLIENTE,"+
			" TELEFONO, SLOGAN, LATITUD,"+
			" LONGITUD, SUCURSAL)"+
			 "VALUES ( @ID_EMPRESA, @ID_MUNICIPIO, @ID_IMAGEN, @ID_REDES_SOCIALES, @NIT, @RAZON_SOCIAL, @DIRECCION_CLIENTE, @TELEFONO, @SLOGAN, @LATITUD, @LONGITUD, @SUCURSAL)";
			...
			stmt.Parameters.AddWithValue("@ID_EMPRESA", valueObject.ID_EMPRESA);
				...
				if(valueObject.ID_REDES_SOCIALES!=0)
					stmt.Parameters.AddWithValue("@ID_REDES_SOCIALES", valueObject.ID_REDES_SOCIALES);
				else
					stmt.Parameters.AddWithValue("@ID_REDES_SOCIALES", DBNull.Value);
	...
	public void save(SqlConnection conn, Empresa valueObject) {
		...
		String sql = "";
		try {
			sql = "UPDATE EMPRESA SET  ID_MUNICIPIO = @ID_MUNICIPIO , ID_IMAGEN = @ID_IMAGEN , ID_REDES_SOCIALES = @ID_REDES_SOCIALES ,"+
